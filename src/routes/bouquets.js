...
router.post('/', async (req, res) => {
  const { receiverUsername = null, message = '', wrapping = 'paper', items = [] } = req.body || {};
  ...
  try {
    ...
    const b = (await client.query(`INSERT INTO bouquets(sender_id,receiver_telegram_id,receiver_username,message,wrapping) VALUES($1,$2,$3,$4,$5) RETURNING *`, [u.id, receiver.telegram_id, receiver.username, message, wrapping])).rows[0];
